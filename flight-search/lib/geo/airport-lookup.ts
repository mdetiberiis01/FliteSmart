...
export const AIRPORT_INFO: Record<string, AirportInfo> = {
  ...
  PVD: { city: 'Providence', country: 'United States' },
...
export const AIRPORT_COORDS: Record<string, [number, number]> = {
  ...
  PHL: [39.87, -75.24], MCO: [28.43, -81.31], BNA: [36.12, -86.68], CLT: [35.21, -80.94],
  AUS: [30.20, -97.67], PDX: [45.59, -122.60], SLC: [40.79, -111.98], SAN: [32.73, -117.19],
  TPA: [27.98, -82.53], PIT: [40.49, -80.23], RDU: [35.88, -78.79], MCI: [39.30, -94.71],
  STL: [38.75, -90.37], CMH: [39.99, -82.89], IND: [39.72, -86.29], CVG: [39.05, -84.67],
  CLE: [41.41, -81.85], MKE: [42.95, -87.90], MSY: [29.99, -90.26], MEM: [35.04, -89.98],
  OKC: [35.39, -97.60], ABQ: [35.04, -106.61], RIC: [37.51, -77.32], JAX: [30.49, -81.69],
  SMF: [38.69, -121.59], SJC: [37.36, -121.93], OAK: [37.72, -122.22], BDL: [41.94, -72.68],
  BUF: [42.94, -78.73], ANC: [61.17, -150.02], BOI: [43.56, -116.22], TUS: [32.12, -110.94],
  ELP: [31.81, -106.38], LIT: [34.73, -92.22], SDF: [38.17, -85.74], OMA: [41.30, -95.89],
  PVD: [41.72, -71.43], ALB: [42.75, -73.80],
  // Canada
