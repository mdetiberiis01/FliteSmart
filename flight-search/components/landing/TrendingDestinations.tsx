...
export interface TrendingDest {
  city: string;
  country: string;
  destination: string; // what to pass as destination param
  price: number;
  photo: string;
  tag?: string;
}
...
const TRENDING: TrendingDest[] = [
  ...
  },
  {
    ...
    destination: 'Phuket',
    price: 480,
    photo: 'https://images.unsplash.com/photo-1589394815804-964ed0be2eb5?w=600&q=80',
  },
];
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-base font-bold text-slate-800 dark:text-white">Trending destinations</h2>
        <span className="text-xs text-slate-400 dark:text-white/40 font-medium uppercase tracking-wide">Tap to search</span>
      </div>
